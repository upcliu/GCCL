...
def process():
    ...
    diffmarks = json.load(open('/home/qustliu/AST/data/pde/diffmark.json'))
    processed_tokens = []
    processed_types = []
    ...
    pickle.dump(processed_tokens, open('/home/qustliu/AST/data/pde/processed_tokens.pkl', 'wb'))
    pickle.dump(processed_types, open('/home/qustliu/AST/data/pde/processed_types.pkl', 'wb'))

if __name__ == '__main__':
    """ if not os.path.exists('processed_tokens.pkl'):
        process() """
    all_num = len(pickle.load(open('/home/qustliu/AST/data/pde/processed_tokens.pkl', 'rb')))
